...
from lottery_api.services import ai_modules_service, ai_service
...
def _detect_provider() -> str:
    ...
    return ai_modules_service.detect_provider()
...
class LLMAnalyzer:
    ...
    def analyze_rsm(self, lottery_type: str, states: dict, trigger: str = 'manual') -> str:
        ...
        try:
            if provider == 'mock':
                ...
                result = ai_service.analyze_text(
                    prompt,
                    caller='lottery_api.llm_analyzer',
                    provider=provider,
                    fallback_fn=lambda: _mock_analyze(lottery_type, states),
                    trigger=trigger,
                    extra={'lottery_type': lottery_type},
                )
        ...
        self._log(lottery_type, provider_used, trigger, tokens, analysis)
        return analysis
