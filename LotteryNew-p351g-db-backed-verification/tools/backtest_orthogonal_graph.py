...
from ai_lab.scripts.orthogonal_graph_portfolio import OrthogonalGraphPortfolio
...
def main():
    ...
    predictor = OrthogonalGraphPortfolio(engine, ai_adapter)
    
    print("=" * 80)
    print("🔬 Phase 28: Orthogonal + Graph 3-Bet Benchmark")
    print("=" * 80)
    ...
    wins = 0
    match_dist = Counter()
    expert_wins = {'AI': 0, 'DMS': 0, 'Graph': 0}
    ...
    print("-" * 80)
    print(f"✅ Final Orthogonal + Graph Rate (150期): {rate:.2f}%")
