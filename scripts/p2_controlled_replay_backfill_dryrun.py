...
def _validate_output_path(output_path: str):
    """Fail before DB access when a caller-selected output cannot be written."""
...
def main():
    ...
    # Validate both destinations before opening SQLite or publishing either file.
    _validate_output_path(args.json_out)
    _validate_output_path(args.csv_out)
