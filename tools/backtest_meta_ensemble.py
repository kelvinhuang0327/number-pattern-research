...
from ai_lab.scripts.meta_ensemble_predictor import MetaEnsemblePredictor
...
def main():
    ...
    predictor = MetaEnsemblePredictor(engine, ai_adapter)
    
    print("=" * 80)
    print("🔬 Phase 27: Meta-Ensemble 3-Bet Benchmark")
    print("=" * 80)
    ...
    print("-" * 80)
    print(f"✅ Final Meta-Ensemble 3-Bet Rate (150期): {rate:.2f}%")
