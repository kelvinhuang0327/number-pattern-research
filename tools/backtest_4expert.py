...
from ai_lab.scripts.four_expert_ensemble import FourExpertEnsemble
...
def main():
    ...
    predictor = FourExpertEnsemble(engine, ai_adapter)
    
    print("=" * 80)
    print("🔬 Phase 29: 4-Expert Ensemble Benchmark")
    print("=" * 80)
    ...
    wins = 0
    match_dist = Counter()
    expert_wins = {'AI': 0, 'DMS': 0, 'Graph': 0, 'Hybrid': 0}
    ...
    print("-" * 80)
    print(f"✅ Final 4-Expert Ensemble Rate (150期): {rate:.2f}%")
