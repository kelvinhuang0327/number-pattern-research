...
from ai_lab.scripts.bayesian_predictor import NeuralBayesianPredictor
...
def main():
    ...
    predictor = NeuralBayesianPredictor(engine, ai_adapter)
    
    print("=" * 80)
    print("🔬 Phase 18: Neural-Bayesian Single-Bet Benchmark")
    print("=" * 80)
    ...
    for i in range(periods):
        ...
        try:
            res = predictor.predict_bayesian(history, rules)
            bet = res['numbers']
    ...
    print("-" * 80)
    print(f"✅ Final Neural-Bayesian Precision (150期): {rate:.2f}%")
