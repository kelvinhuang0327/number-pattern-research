...
| 大樂透 4注 | BIG_LOTTO | 4 | TS3+Markov(w=30) | +1.23% (historical, NOT_ESTABLISHED) |
...
> ⚠️ **大樂透 4注**：evidence_status=HISTORICAL_RESEARCH_ONLY, current_significance=NOT_ESTABLISHED（2026-07-25 legacy-continuity 訂正）。
> No reliable predictive advantage is currently established. +1.23% 僅為歷史回測描述性紀錄。
...
| 大樂透 | 4注 | TS3+Markov(w=30) | 8.47% | 7.25% | +1.23% (historical, NOT_ESTABLISHED) |
