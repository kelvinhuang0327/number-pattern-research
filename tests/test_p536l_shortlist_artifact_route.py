"""Tests for the P536L read-only lift candidate shortlist artifact route."""
...
ARTIFACT = REPO_ROOT / "outputs/research/p536k_lift_candidate_shortlist_20260708.json"
...
def test_route_serves_200_and_reuses_committed_artifact():
    ...
    response = _client().get("/api/replay/lift-candidate-shortlist")
