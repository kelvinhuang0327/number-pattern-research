...
def backtest_multi(method_names, test_periods=150):
    ...
    print("=" * 60)
    print(f"🔬 威力彩 {len(methods)} 注組合 150 期回測（獨立腳本）")
    print("=" * 60)
    print(f"方法組合:")
...
def main():
    parser = argparse.ArgumentParser(description='威力彩 150 期回測（獨立腳本）')
