# P536K — Lift Candidate Shortlist (Review Artifact)

> Historical replay review artifact only; not a prediction, betting edge, future-winning, or production-readiness claim.

Derived from: **P536C** (`outputs/research/p536c_success_matrix_lift_extension_20260708.json`)

## Counts

- stable_300_750_review_candidates: **177**
- short_window_spike_review_candidates: **90**
- combination_review_candidates: **133**
- cross_lottery_review_candidates: **60**

## Stable 300/750 Review Candidates
...
## Short-Window Spike Review Candidates (window=50, review-only)
...
## Combination Review Candidates (present in ≥2 windows)

| lottery | combo_id | budget | windows_present | stability_rank |
|---|---|---:|---|---:|
| BIG_LOTTO | `ts3_regime_3bet:1` | 1 | [50, 300, 750] | 1 |
| BIG_LOTTO | `biglotto_deviation_2bet:2` | 2 | [50, 300, 750] | 1 |
| BIG_LOTTO | `biglotto_echo_aware_3bet:2 + biglotto_ts3_markov_4bet_w30:1` | 3 | [50, 300] | 1 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:2 + biglotto_deviation_2bet:2` | 4 | [50, 300, 750] | 1 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:2 + biglotto_deviation_2bet:2 + markov_single_biglotto:1` | 5 | [300, 750] | 1 |
| BIG_LOTTO | `biglotto_deviation_2bet:2 + markov_single_biglotto:2 + ts3_regime_3bet:2` | 6 | [50, 300, 750] | 1 |
| BIG_LOTTO | `biglotto_ts3_markov_4bet_w30:1` | 1 | [50, 300, 750] | 2 |
| BIG_LOTTO | `biglotto_ts3_markov_4bet_w30:2` | 2 | [50, 300] | 2 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:1 + biglotto_echo_aware_3bet:2` | 3 | [50, 300] | 2 |
| BIG_LOTTO | `biglotto_deviation_2bet:2 + ts3_regime_3bet:2` | 4 | [50, 300, 750] | 2 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:2 + biglotto_deviation_2bet:2 + markov_2bet_biglotto:1` | 5 | [300, 750] | 2 |
| BIG_LOTTO | `biglotto_deviation_2bet:2 + markov_2bet_biglotto:2 + ts3_regime_3bet:2` | 6 | [50, 300, 750] | 2 |
| BIG_LOTTO | `biglotto_triple_strike:1` | 1 | [50, 300, 750] | 3 |
| BIG_LOTTO | `biglotto_echo_aware_3bet:2` | 2 | [50, 300] | 3 |
| BIG_LOTTO | `biglotto_echo_aware_3bet:2 + ts3_regime_3bet:1` | 3 | [50, 300] | 3 |
| BIG_LOTTO | `biglotto_deviation_2bet:2 + biglotto_ts3_markov_4bet_w30:2` | 4 | [50, 300, 750] | 3 |
| BIG_LOTTO | `biglotto_deviation_2bet:2 + biglotto_echo_aware_3bet:2 + ts3_regime_3bet:2` | 6 | [50, 300] | 3 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:1` | 1 | [50, 300, 750] | 4 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:2` | 2 | [50, 300] | 4 |
| BIG_LOTTO | `biglotto_echo_aware_3bet:2 + biglotto_triple_strike:1` | 3 | [50, 300] | 4 |
| BIG_LOTTO | `biglotto_deviation_2bet:2 + biglotto_triple_strike:2` | 4 | [50, 300, 750] | 4 |
| BIG_LOTTO | `biglotto_deviation_2bet:2 + biglotto_echo_aware_3bet:2 + biglotto_ts3_markov_4bet_w30:2` | 6 | [50, 300] | 4 |
| BIG_LOTTO | `markov_single_biglotto:1` | 1 | [50, 300, 750] | 5 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:1 + biglotto_deviation_2bet:1` | 2 | [300, 750] | 5 |
| BIG_LOTTO | `bet2_fourier_expansion_biglotto:1 + biglotto_deviation_2bet:2` | 3 | [300, 750] | 5 |

_...and 108 more rows in the JSON artifact._

## Cross-Lottery Review Candidates (≥2 lotteries, side-by-side, never pooled)
...
- source_generated_at: `2026-07-08T07:42:01.782116+00:00`
- source_data_hash_sha256: `46d49ea1fc20e240205ab6fa87b70800e6dbfabfee927fc06e532b4b61b4c8d2`
- selection_method: Deterministic filters over fields already present in the P536C artifact only. No database access, no route/API/UI change, no new statistical metric, and no recomputation from raw replay rows — every numeric value here is copied verbatim from the source artifact.
- limitations:
