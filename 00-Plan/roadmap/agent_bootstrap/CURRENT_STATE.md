...
**Last Reviewed:** 2026-06-08 Asia/Taipei (P258B external-response evaluation COMPLETE — D2 HARD_REJECT, D1 REJECT_INSUFFICIENT_EVIDENCE, D3 AdversarialNullSurvivorGate ACCEPTED as read-only pre-registration candidate; methodology gate, not predictor; next P258C D3 pre-registration design, strong model required; DB 94924 unchanged)
**State Marker:** `P258B_READ_ONLY_PREREGISTRATION_CANDIDATE_SELECTED`
