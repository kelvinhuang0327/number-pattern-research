...
- **P258J** (next): read-only synthetic integration skeleton tests / dry-contract fixtures only. Requires separate explicit authorization.

```text
P258I_D3_READ_ONLY_CONTRACT_VALIDATION_INTEGRATION_SKELETON_READY_20260609
```
