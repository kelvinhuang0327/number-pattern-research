...
**Last Reviewed:** 2026-06-08 Asia/Taipei (P258C D3 AdversarialNullSurvivorGate read-only pre-registration design COMPLETE — falsification-only gate, not a predictor, never promotes; matched adversarial-null family + provenance/leakage gates + paired-vs-P257A and null-percentile endpoints; PR #373 P258B merged; next P258D read-only implementation plan only; DB 94924 unchanged)
**State Marker:** `P258C_D3_READ_ONLY_PREREGISTRATION_DESIGN_READY`
