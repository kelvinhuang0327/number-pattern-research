...
def analyze_distribution():
    ...
    # The script is in lottery-api/analyze_bonus_distribution.py
    # The DB is in lottery-api/data/lottery_v2.db
    
    current_dir = os.path.dirname(os.path.abspath(__file__))
    # if we are running from root, current_dir might be just 'lottery-api' or similar if resolved relative
    # Let's try explicit paths
    
    possible_paths = [
        "data/lottery_v2.db", # If running from lottery-api dir
        "lottery-api/data/lottery_v2.db", # If running from root dir
