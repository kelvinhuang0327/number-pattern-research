...
from ai_lab.scripts.ai_dominant_predictor import AIDominantPredictor
...
def main():
    ...
    predictor = AIDominantPredictor(engine, ai_adapter)
    
    print("=" * 80)
    print("🔬 Phase 21: AI-Dominant Single-Bet Benchmark")
    print("=" * 80)
    ...
    for i in range(periods):
        ...
        try:
            res = predictor.predict_precision(history, rules)
            bet = res['numbers']
    ...
    print("-" * 80)
    print(f"✅ Final AI-Dominant Precision (150期): {rate:.2f}%")
