...
def main():
    ...
    # Fix database path
    # db_manager defaults to "data/lottery_v2.db", but relative to root it should be "lottery-api/data/lottery_v2.db"
    # or absolute path.
    import os
    ...
    for target_draw in draws_2025:
        ...
        try:
            ...
            ensemble_res = ensemble.predict(history, lottery_rules, backtest_periods=15)
